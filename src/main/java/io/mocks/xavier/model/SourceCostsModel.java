...
public class SourceCostsModel
{
    ...
    public SourceCostsModel() {
        sourceLicenseValue = 123456D;
        sourceMaintenanceValue = 123456D;
        year1Server = 123456;
        year1SourceValue = 123456D;

        sourceRenewHighValue = 123456D;
        sourceRenewLikelyValue= 123456D;
        sourceRenewLowValue = 123456D;
    }
